...
from .views import CruceAnualView, DeclaracionesView, DeudaView, PanoramaView, PlanillaDeclaradaView, PlanillaHistoricoView, RentaAnualView
...
urlpatterns = [
    ...
    path("declaraciones/deuda/", DeudaView.as_view(), name="deuda"),
    path("declaraciones/planilla/", PlanillaDeclaradaView.as_view(), name="planilla"),
    path("declaraciones/planilla/historico/", PlanillaHistoricoView.as_view(), name="planilla-historico"),
]
